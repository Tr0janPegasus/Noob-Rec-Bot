...
client.on("messageCreate", (message) => {
    if (message.content === ">avi") {
        message.reply({
            content: "Currently, I am a learner, developer, student, and social entrepreneur. I love to learn anything new, especially, in the field of tech. Previously, I have worked in development and leadership roles in the field of tech at various student organizations. In the future, I wish to further my career in tech.\n Apart from my career, I enjoy gaming, reading novels, watching movies, and anime.✌\n I am always happy to chat, feel free to contact me. 😁\n\n Follow me on Github: https://github.com/AviAvinav",
        });
    }
        ...
        for (let i = 0; i < 20; i++){
        message.reply({
            content: "CRITERIO#8351 ki CRITERIO#8351\n",
        })};
        message.reply({
